...
public:
    ...
    Result<void, Error> UpdateTuple(const RID & rid, std::unordered_map<std::string, AbstractData*> set, BufferManager * buffer_manager, const CatalogTable * catalog_table);
};
